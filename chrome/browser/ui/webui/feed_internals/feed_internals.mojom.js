...
(function() {
  ...
  UserClassifier.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.userClassDescription =
        decoder.decodeStruct(codec.String);
    val.avgHoursBetweenViews =
        decoder.decodeStruct(codec.Float);
    val.avgHoursBetweenUses =
        decoder.decodeStruct(codec.Float);
    return val;
  };
  ...
  PageHandler_GetUserClassifierProperties_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.properties =
        decoder.decodeStructPointer(UserClassifier);
    return val;
  };
  ...
  PageHandler_GetCurrentContent_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.suggestions =
        decoder.decodeArrayPointer(new codec.PointerTo(Suggestion));
    return val;
  };
  ...
  function PageHandler_OverrideActionUploadEndpoint_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  PageHandler_OverrideActionUploadEndpoint_Params.prototype.initDefaults_ = function() {
    this.endpointUrl = null;
  };
  PageHandler_OverrideActionUploadEndpoint_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  PageHandler_OverrideActionUploadEndpoint_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate PageHandler_OverrideActionUploadEndpoint_Params.endpointUrl
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PageHandler_OverrideActionUploadEndpoint_Params.encodedSize = codec.kStructHeaderSize + 8;

  PageHandler_OverrideActionUploadEndpoint_Params.decode = function(decoder) {
    var packed;
    var val = new PageHandler_OverrideActionUploadEndpoint_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.endpointUrl =
        decoder.decodeStructPointer(url$.Url);
  ...
  PageHandler_OverrideActionUploadEndpoint_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(PageHandler_OverrideActionUploadEndpoint_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  var kPageHandler_OverrideFeedHost_Name = 9;
  var kPageHandler_OverrideActionUploadEndpoint_Name = 10;
  ...
  PageHandlerPtr.prototype.overrideActionUploadEndpoint = function() {
    return PageHandlerProxy.prototype.overrideActionUploadEndpoint
        .apply(this.ptr.getProxy(), arguments);
  };

  PageHandlerProxy.prototype.overrideActionUploadEndpoint = function(endpointUrl) {
    var params_ = new PageHandler_OverrideActionUploadEndpoint_Params();
    params_.endpointUrl = endpointUrl;
    var builder = new codec.MessageV0Builder(
        kPageHandler_OverrideActionUploadEndpoint_Name,
        codec.align(PageHandler_OverrideActionUploadEndpoint_Params.encodedSize));
    builder.encodeStruct(PageHandler_OverrideActionUploadEndpoint_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  PageHandlerStub.prototype.overrideActionUploadEndpoint = function(endpointUrl) {
    return this.delegate_ && this.delegate_.overrideActionUploadEndpoint && this.delegate_.overrideActionUploadEndpoint(endpointUrl);
  }
  ...
  PageHandlerStub.prototype.accept = function(message) {
    ...
    case kPageHandler_OverrideFeedHost_Name:
      ...
      return true;
    case kPageHandler_OverrideActionUploadEndpoint_Name:
      var params = reader.decodeStruct(PageHandler_OverrideActionUploadEndpoint_Params);
      this.overrideActionUploadEndpoint(params.endpointUrl);
      return true;
    default:
      return false;
    }
  ...
  function validatePageHandlerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kPageHandler_OverrideActionUploadEndpoint_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = PageHandler_OverrideActionUploadEndpoint_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
