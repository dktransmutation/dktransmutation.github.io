...
(function() {
  ...
  SuggestionCategory.decode = function(decoder) {
    ...
    val.status =
        decoder.decodeStruct(codec.String);
    val.suggestions =
        decoder.decodeArrayPointer(new codec.PointerTo(SuggestionItem));
    val.dismissedSuggestions =
        decoder.decodeArrayPointer(new codec.PointerTo(SuggestionItem));
    return val;
  };
  ...
  SuggestionItem.decode = function(decoder) {
    ...
    val.suggestionId =
        decoder.decodeStruct(codec.String);
    val.suggestionIdWithinCategory =
        decoder.decodeStruct(codec.String);
    val.url =
        decoder.decodeStruct(codec.String);
    val.faviconUrl =
  ...
  PageHandlerFactory_CreatePageHandler_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.handler =
        decoder.decodeStruct(new codec.Interface(PageHandlerPtr));
    return val;
  };
  ...
  PageHandler_GetSuggestionsByCategory_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.categories =
        decoder.decodeArrayPointer(new codec.PointerTo(SuggestionCategory));
    return val;
  };
