...
(function() {
  ...
  VisualProperties.prototype.initDefaults_ = function() {
    ...
    this.localSurfaceIdAllocation = null;
  ...
  VisualProperties.validate = function(messageValidator, offset) {
    ...
    // validate VisualProperties.localSurfaceIdAllocation
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 64, local_surface_id_allocation$.LocalSurfaceIdAllocation, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 88, 8, new codec.PointerTo(geometry$.Rect), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VisualProperties.encodedSize = codec.kStructHeaderSize + 96;
  ...
  VisualProperties.decode = function(decoder) {
    ...
    val.localSurfaceIdAllocation =
        decoder.decodeStructPointer(local_surface_id_allocation$.LocalSurfaceIdAllocation);
  ...
  VisualProperties.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(local_surface_id_allocation$.LocalSurfaceIdAllocation, val.localSurfaceIdAllocation);
