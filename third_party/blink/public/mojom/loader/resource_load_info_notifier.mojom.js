...
(function() {
  ...
  ResourceLoadInfoNotifier_NotifyResourceResponseReceived_Params.validate = function(messageValidator, offset) {
    ...
    // validate ResourceLoadInfoNotifier_NotifyResourceResponseReceived_Params.resourceLoadInfo
  ...
  ResourceLoadInfoNotifier_NotifyResourceResponseReceived_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  ResourceLoadInfoNotifier_NotifyResourceTransferSizeUpdated_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  ResourceLoadInfoNotifierProxy.prototype.notifyResourceResponseReceived = function(resourceLoadInfo, head, previewsState) {
  ...
  ResourceLoadInfoNotifierStub.prototype.notifyResourceResponseReceived = function(resourceLoadInfo, head, previewsState) {
    return this.delegate_ && this.delegate_.notifyResourceResponseReceived && this.delegate_.notifyResourceResponseReceived(resourceLoadInfo, head, previewsState);
  }
  ...
  ResourceLoadInfoNotifierStub.prototype.accept = function(message) {
    ...
    case kResourceLoadInfoNotifier_NotifyResourceResponseReceived_Name:
      ...
      this.notifyResourceResponseReceived(params.resourceLoadInfo, params.head, params.previewsState);
      return true;
