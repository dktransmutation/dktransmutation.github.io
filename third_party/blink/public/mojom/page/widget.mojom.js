...
(function() {
  ...
  var local_surface_id_allocation$ =
      mojo.internal.exposeNamespace('viz.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/viz/public/mojom/compositing/local_surface_id_allocation.mojom', '../../../../../services/viz/public/mojom/compositing/local_surface_id_allocation.mojom.js');
  }
  ...
  FrameWidget_DragTargetDragOver_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, drag$.DragOperation);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FrameWidget_DragSourceEndedAt_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 16, drag$.DragOperation);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kFrameWidget_DragTargetDragOver_Name = 0;
  var kFrameWidget_DragTargetDragLeave_Name = 1;
  var kFrameWidget_DragTargetDrop_Name = 2;
  var kFrameWidget_DragSourceEndedAt_Name = 3;
  var kFrameWidget_DragSourceSystemDragEnded_Name = 4;
  var kFrameWidget_SetBackgroundOpaque_Name = 5;
  var kFrameWidget_SetTextDirection_Name = 6;
  var kFrameWidget_SetInheritedEffectiveTouchActionForSubFrame_Name = 7;
  var kFrameWidget_UpdateRenderThrottlingStatusForSubFrame_Name = 8;
  var kFrameWidget_SetIsInertForSubFrame_Name = 9;
  var kFrameWidget_ShowContextMenu_Name = 10;
  var kFrameWidget_EnableDeviceEmulation_Name = 11;
  var kFrameWidget_DisableDeviceEmulation_Name = 12;
  var kFrameWidget_BindWidgetCompositor_Name = 13;
  ...
  FrameWidgetProxy.prototype.updateRenderThrottlingStatusForSubFrame = function(isThrottled, subtreeThrottled) {
  ...
  FrameWidgetStub.prototype.updateRenderThrottlingStatusForSubFrame = function(isThrottled, subtreeThrottled) {
    return this.delegate_ && this.delegate_.updateRenderThrottlingStatusForSubFrame && this.delegate_.updateRenderThrottlingStatusForSubFrame(isThrottled, subtreeThrottled);
  }
  ...
  FrameWidgetStub.prototype.accept = function(message) {
    ...
    case kFrameWidget_UpdateRenderThrottlingStatusForSubFrame_Name:
      ...
      this.updateRenderThrottlingStatusForSubFrame(params.isThrottled, params.subtreeThrottled);
      return true;
