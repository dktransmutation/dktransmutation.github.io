...
(function() {
  ...
  AuthenticatorStatus.UNKNOWN_ERROR = 19;
  AuthenticatorStatus.MIN_VALUE = 0,
  AuthenticatorStatus.MAX_VALUE = 19,
  ...
  UvmEntry.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.userVerificationMethod =
        decoder.decodeStruct(codec.Uint32);
    val.keyProtectionType =
        decoder.decodeStruct(codec.Uint16);
    val.matcherProtectionType =
        decoder.decodeStruct(codec.Uint16);
    return val;
  };
  ...
  MakeCredentialAuthenticatorResponse.decode = function(decoder) {
    ...
    val.echoUserVerificationMethods = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.publicKeyAlgo =
    ...
    val.publicKeyDer =
        decoder.decodeArrayPointer(codec.Uint8);
    val.userVerificationMethods =
        decoder.decodeArrayPointer(new codec.PointerTo(UvmEntry));
    return val;
  };
  ...
  MakeCredentialAuthenticatorResponse.encode = function(encoder, val) {
    ...
    packed |= (val.prf & 1) << 3
    packed |= (val.echoUserVerificationMethods & 1) << 4
  ...
  GetAssertionAuthenticatorResponse.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 40, PRFValues, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PublicKeyCredentialCreationOptions.decode = function(decoder) {
    ...
    val.userVerificationMethods = (packed >> 2) & 1 ? true : false;
    val.enforceProtectionPolicy = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PublicKeyCredentialCreationOptions.encode = function(encoder, val) {
    ...
    packed |= (val.userVerificationMethods & 1) << 2
    packed |= (val.enforceProtectionPolicy & 1) << 3
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
