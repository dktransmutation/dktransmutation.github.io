...
(function() {
  ...
  SingletonJavaScriptValue.kUndefined = 1;
  ...
  RemoteInvocationError.METHOD_NOT_FOUND = 1;
  RemoteInvocationError.OBJECT_GET_CLASS_BLOCKED = 2;
  RemoteInvocationError.EXCEPTION_THROWN = 3;
  ...
  RemoteInvocationResult.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.value =
        decoder.decodeStruct(RemoteInvocationResultValue);
    return val;
  };
  ...
  RemoteObjectHost_GetObject_Params.validate = function(messageValidator, offset) {
    ...
    // validate RemoteObjectHost_GetObject_Params.receiver
  ...
  RemoteObject_InvokeMethod_Params.decode = function(decoder) {
    ...
    val.name =
        decoder.decodeStruct(codec.String);
    val.arguments =
        decoder.decodeArrayPointer(RemoteInvocationArgument);
    return val;
  };
  ...
  RemoteObject_InvokeMethod_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStructPointer(RemoteInvocationResult);
    return val;
  };
  ...
  function RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.prototype.initDefaults_ = function() {
    this.host = new RemoteObjectHostPtr();
    this.gateway = new bindings.InterfaceRequest();
  };
  RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.host
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 0, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.gateway
  ...
  RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.encodedSize = codec.kStructHeaderSize + 16;

  RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.decode = function(decoder) {
    var packed;
    var val = new RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.host =
        decoder.decodeStruct(new codec.Interface(RemoteObjectHostPtr));
    val.gateway =
        decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
  ...
  RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(new codec.Interface(RemoteObjectHostPtr), val.host);
    encoder.encodeStruct(codec.InterfaceRequest, val.gateway);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  };
  function RemoteObjectGateway_AddNamedObject_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  RemoteObjectGateway_AddNamedObject_Params.prototype.initDefaults_ = function() {
    this.name = null;
    this.objectId = 0;
  };
  RemoteObjectGateway_AddNamedObject_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  RemoteObjectGateway_AddNamedObject_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate RemoteObjectGateway_AddNamedObject_Params.name
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RemoteObjectGateway_AddNamedObject_Params.encodedSize = codec.kStructHeaderSize + 16;

  RemoteObjectGateway_AddNamedObject_Params.decode = function(decoder) {
    var packed;
    var val = new RemoteObjectGateway_AddNamedObject_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.name =
        decoder.decodeStruct(codec.String);
  ...
  RemoteObjectGateway_AddNamedObject_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(RemoteObjectGateway_AddNamedObject_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.name);
    encoder.encodeStruct(codec.Int32, val.objectId);
    encoder.skip(1);
  ...
  function RemoteObjectGateway_RemoveNamedObject_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  RemoteObjectGateway_RemoveNamedObject_Params.prototype.initDefaults_ = function() {
    this.name = null;
  };
  RemoteObjectGateway_RemoveNamedObject_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  RemoteObjectGateway_RemoveNamedObject_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate RemoteObjectGateway_RemoveNamedObject_Params.name
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RemoteObjectGateway_RemoveNamedObject_Params.encodedSize = codec.kStructHeaderSize + 8;

  RemoteObjectGateway_RemoveNamedObject_Params.decode = function(decoder) {
    var packed;
    var val = new RemoteObjectGateway_RemoveNamedObject_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.name =
        decoder.decodeStruct(codec.String);
  ...
  RemoteObjectGateway_RemoveNamedObject_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(RemoteObjectGateway_RemoveNamedObject_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.name);
  };
  ...
  RemoteObjectHostProxy.prototype.getObject = function(objectId, receiver) {
  ...
  RemoteObjectHostStub.prototype.getObject = function(objectId, receiver) {
  ...
  var kRemoteObjectGatewayFactory_CreateRemoteObjectGateway_Name = 0;

  function RemoteObjectGatewayFactoryPtr(handleOrPtrInfo) {
    this.ptr = new bindings.InterfacePtrController(RemoteObjectGatewayFactory,
                                                   handleOrPtrInfo);
  }

  function RemoteObjectGatewayFactoryAssociatedPtr(associatedInterfacePtrInfo) {
    this.ptr = new associatedBindings.AssociatedInterfacePtrController(
        RemoteObjectGatewayFactory, associatedInterfacePtrInfo);
  }

  RemoteObjectGatewayFactoryAssociatedPtr.prototype =
      Object.create(RemoteObjectGatewayFactoryPtr.prototype);
  RemoteObjectGatewayFactoryAssociatedPtr.prototype.constructor =
      RemoteObjectGatewayFactoryAssociatedPtr;

  function RemoteObjectGatewayFactoryProxy(receiver) {
    this.receiver_ = receiver;
  }
  RemoteObjectGatewayFactoryPtr.prototype.createRemoteObjectGateway = function() {
    return RemoteObjectGatewayFactoryProxy.prototype.createRemoteObjectGateway
        .apply(this.ptr.getProxy(), arguments);
  };

  RemoteObjectGatewayFactoryProxy.prototype.createRemoteObjectGateway = function(host, gateway) {
    var params_ = new RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params();
    params_.host = host;
    params_.gateway = gateway;
    var builder = new codec.MessageV0Builder(
        kRemoteObjectGatewayFactory_CreateRemoteObjectGateway_Name,
        codec.align(RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params.encodedSize));
    builder.encodeStruct(RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };

  function RemoteObjectGatewayFactoryStub(delegate) {
    this.delegate_ = delegate;
  }
  RemoteObjectGatewayFactoryStub.prototype.createRemoteObjectGateway = function(host, gateway) {
    return this.delegate_ && this.delegate_.createRemoteObjectGateway && this.delegate_.createRemoteObjectGateway(host, gateway);
  }

  RemoteObjectGatewayFactoryStub.prototype.accept = function(message) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kRemoteObjectGatewayFactory_CreateRemoteObjectGateway_Name:
      var params = reader.decodeStruct(RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params);
      this.createRemoteObjectGateway(params.host, params.gateway);
      return true;
    default:
      return false;
    }
  ...
  RemoteObjectGatewayFactoryStub.prototype.acceptWithResponder =
      function(message, responder) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    default:
  ...
  function validateRemoteObjectGatewayFactoryRequest(messageValidator) {
    var message = messageValidator.message;
    var paramsClass = null;
    switch (message.getName()) {
      case kRemoteObjectGatewayFactory_CreateRemoteObjectGateway_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = RemoteObjectGatewayFactory_CreateRemoteObjectGateway_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateRemoteObjectGatewayFactoryResponse(messageValidator) {
    return validator.validationError.NONE;
  }

  var RemoteObjectGatewayFactory = {
    name: 'blink.mojom.RemoteObjectGatewayFactory',
    kVersion: 0,
    ptrClass: RemoteObjectGatewayFactoryPtr,
    proxyClass: RemoteObjectGatewayFactoryProxy,
    stubClass: RemoteObjectGatewayFactoryStub,
    validateRequest: validateRemoteObjectGatewayFactoryRequest,
    validateResponse: null,
  };
  RemoteObjectGatewayFactoryStub.prototype.validator = validateRemoteObjectGatewayFactoryRequest;
  RemoteObjectGatewayFactoryProxy.prototype.validator = null;
  var kRemoteObjectGateway_AddNamedObject_Name = 0;
  var kRemoteObjectGateway_RemoveNamedObject_Name = 1;

  function RemoteObjectGatewayPtr(handleOrPtrInfo) {
    this.ptr = new bindings.InterfacePtrController(RemoteObjectGateway,
                                                   handleOrPtrInfo);
  }

  function RemoteObjectGatewayAssociatedPtr(associatedInterfacePtrInfo) {
    this.ptr = new associatedBindings.AssociatedInterfacePtrController(
        RemoteObjectGateway, associatedInterfacePtrInfo);
  }

  RemoteObjectGatewayAssociatedPtr.prototype =
      Object.create(RemoteObjectGatewayPtr.prototype);
  RemoteObjectGatewayAssociatedPtr.prototype.constructor =
      RemoteObjectGatewayAssociatedPtr;

  function RemoteObjectGatewayProxy(receiver) {
    this.receiver_ = receiver;
  }
  RemoteObjectGatewayPtr.prototype.addNamedObject = function() {
    return RemoteObjectGatewayProxy.prototype.addNamedObject
        .apply(this.ptr.getProxy(), arguments);
  };

  RemoteObjectGatewayProxy.prototype.addNamedObject = function(name, objectId) {
    var params_ = new RemoteObjectGateway_AddNamedObject_Params();
    params_.name = name;
    params_.objectId = objectId;
    var builder = new codec.MessageV0Builder(
        kRemoteObjectGateway_AddNamedObject_Name,
        codec.align(RemoteObjectGateway_AddNamedObject_Params.encodedSize));
    builder.encodeStruct(RemoteObjectGateway_AddNamedObject_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  RemoteObjectGatewayPtr.prototype.removeNamedObject = function() {
    return RemoteObjectGatewayProxy.prototype.removeNamedObject
        .apply(this.ptr.getProxy(), arguments);
  };

  RemoteObjectGatewayProxy.prototype.removeNamedObject = function(name) {
    var params_ = new RemoteObjectGateway_RemoveNamedObject_Params();
    params_.name = name;
    var builder = new codec.MessageV0Builder(
        kRemoteObjectGateway_RemoveNamedObject_Name,
        codec.align(RemoteObjectGateway_RemoveNamedObject_Params.encodedSize));
    builder.encodeStruct(RemoteObjectGateway_RemoveNamedObject_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };

  function RemoteObjectGatewayStub(delegate) {
    this.delegate_ = delegate;
  }
  RemoteObjectGatewayStub.prototype.addNamedObject = function(name, objectId) {
    return this.delegate_ && this.delegate_.addNamedObject && this.delegate_.addNamedObject(name, objectId);
  }
  RemoteObjectGatewayStub.prototype.removeNamedObject = function(name) {
    return this.delegate_ && this.delegate_.removeNamedObject && this.delegate_.removeNamedObject(name);
  }

  RemoteObjectGatewayStub.prototype.accept = function(message) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kRemoteObjectGateway_AddNamedObject_Name:
      var params = reader.decodeStruct(RemoteObjectGateway_AddNamedObject_Params);
      this.addNamedObject(params.name, params.objectId);
      return true;
    case kRemoteObjectGateway_RemoveNamedObject_Name:
      var params = reader.decodeStruct(RemoteObjectGateway_RemoveNamedObject_Params);
  ...
  RemoteObjectGatewayStub.prototype.acceptWithResponder =
      function(message, responder) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    default:
  ...
  function validateRemoteObjectGatewayRequest(messageValidator) {
    var message = messageValidator.message;
    var paramsClass = null;
    switch (message.getName()) {
      case kRemoteObjectGateway_AddNamedObject_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = RemoteObjectGateway_AddNamedObject_Params;
      break;
      case kRemoteObjectGateway_RemoveNamedObject_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = RemoteObjectGateway_RemoveNamedObject_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateRemoteObjectGatewayResponse(messageValidator) {
    return validator.validationError.NONE;
  }

  var RemoteObjectGateway = {
    name: 'blink.mojom.RemoteObjectGateway',
    kVersion: 0,
    ptrClass: RemoteObjectGatewayPtr,
    proxyClass: RemoteObjectGatewayProxy,
    stubClass: RemoteObjectGatewayStub,
    validateRequest: validateRemoteObjectGatewayRequest,
    validateResponse: null,
  };
  RemoteObjectGatewayStub.prototype.validator = validateRemoteObjectGatewayRequest;
  RemoteObjectGatewayProxy.prototype.validator = null;
  ...
  exports.RemoteObjectGatewayFactory = RemoteObjectGatewayFactory;
  exports.RemoteObjectGatewayFactoryPtr = RemoteObjectGatewayFactoryPtr;
  exports.RemoteObjectGatewayFactoryAssociatedPtr = RemoteObjectGatewayFactoryAssociatedPtr;
  exports.RemoteObjectGateway = RemoteObjectGateway;
  exports.RemoteObjectGatewayPtr = RemoteObjectGatewayPtr;
  exports.RemoteObjectGatewayAssociatedPtr = RemoteObjectGatewayAssociatedPtr;
})();