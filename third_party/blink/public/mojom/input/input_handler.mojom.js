...
(function() {
  ...
  WidgetInputHandlerHost_RequestMouseLock_Params.decode = function(decoder) {
    ...
    val.privileged = (packed >> 1) & 1 ? true : false;
    val.unadjustedMovement = (packed >> 2) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  WidgetInputHandlerHost_RequestMouseLock_Params.encode = function(encoder, val) {
    ...
    packed |= (val.privileged & 1) << 1
    packed |= (val.unadjustedMovement & 1) << 2
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  function FrameWidgetInputHandler_SelectWordAroundCaret_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FrameWidgetInputHandler_SelectWordAroundCaret_Params.prototype.initDefaults_ = function() {
  };
  FrameWidgetInputHandler_SelectWordAroundCaret_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FrameWidgetInputHandler_SelectWordAroundCaret_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FrameWidgetInputHandler_SelectWordAroundCaret_Params.encodedSize = codec.kStructHeaderSize + 0;

  FrameWidgetInputHandler_SelectWordAroundCaret_Params.decode = function(decoder) {
    var packed;
    var val = new FrameWidgetInputHandler_SelectWordAroundCaret_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  FrameWidgetInputHandler_SelectWordAroundCaret_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FrameWidgetInputHandler_SelectWordAroundCaret_Params.encodedSize);
    encoder.writeUint32(0);
  };
  function FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.prototype.initDefaults_ = function() {
    this.didSelect = false;
    this.startAdjust = 0;
    this.endAdjust = 0;
  };
  FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.encodedSize = codec.kStructHeaderSize + 16;

  FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
    val.didSelect = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.startAdjust =
  ...
  FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
    packed |= (val.didSelect & 1) << 0
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStruct(codec.Int32, val.startAdjust);
    encoder.encodeStruct(codec.Int32, val.endAdjust);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  WidgetInputHandlerHostProxy.prototype.requestMouseLock = function(fromUserGesture, privileged, unadjustedMovement) {
    var params_ = new WidgetInputHandlerHost_RequestMouseLock_Params();
    params_.fromUserGesture = fromUserGesture;
    params_.privileged = privileged;
  ...
  WidgetInputHandlerHostStub.prototype.requestMouseLock = function(fromUserGesture, privileged, unadjustedMovement) {
    return this.delegate_ && this.delegate_.requestMouseLock && this.delegate_.requestMouseLock(fromUserGesture, privileged, unadjustedMovement);
  }
  ...
  WidgetInputHandlerHostStub.prototype.acceptWithResponder =
    ...
    case kWidgetInputHandlerHost_RequestMouseLock_Name:
      ...
      this.requestMouseLock(params.fromUserGesture, params.privileged, params.unadjustedMovement).then(function(response) {
        var responseParams =
  ...
  var kFrameWidgetInputHandler_SelectWordAroundCaret_Name = 22;
  var kFrameWidgetInputHandler_MoveRangeSelectionExtent_Name = 23;
  var kFrameWidgetInputHandler_ScrollFocusedEditableNodeIntoRect_Name = 24;
  var kFrameWidgetInputHandler_MoveCaret_Name = 25;
  ...
  FrameWidgetInputHandlerPtr.prototype.selectWordAroundCaret = function() {
    return FrameWidgetInputHandlerProxy.prototype.selectWordAroundCaret
        .apply(this.ptr.getProxy(), arguments);
  };

  FrameWidgetInputHandlerProxy.prototype.selectWordAroundCaret = function() {
    var params_ = new FrameWidgetInputHandler_SelectWordAroundCaret_Params();
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kFrameWidgetInputHandler_SelectWordAroundCaret_Name,
          codec.align(FrameWidgetInputHandler_SelectWordAroundCaret_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(FrameWidgetInputHandler_SelectWordAroundCaret_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  FrameWidgetInputHandlerStub.prototype.selectWordAroundCaret = function() {
    return this.delegate_ && this.delegate_.selectWordAroundCaret && this.delegate_.selectWordAroundCaret();
  }
  ...
  FrameWidgetInputHandlerStub.prototype.acceptWithResponder =
    ...
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kFrameWidgetInputHandler_SelectWordAroundCaret_Name:
      var params = reader.decodeStruct(FrameWidgetInputHandler_SelectWordAroundCaret_Params);
      this.selectWordAroundCaret().then(function(response) {
        var responseParams =
            new FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams();
        responseParams.didSelect = response.didSelect;
        responseParams.startAdjust = response.startAdjust;
        responseParams.endAdjust = response.endAdjust;
        var builder = new codec.MessageV1Builder(
            kFrameWidgetInputHandler_SelectWordAroundCaret_Name,
            codec.align(FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateFrameWidgetInputHandlerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kFrameWidgetInputHandler_SelectWordAroundCaret_Name:
        if (message.expectsResponse())
          paramsClass = FrameWidgetInputHandler_SelectWordAroundCaret_Params;
      break;
      case kFrameWidgetInputHandler_MoveRangeSelectionExtent_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  function validateFrameWidgetInputHandlerResponse(messageValidator) {
   ...
   switch (message.getName()) {
      case kFrameWidgetInputHandler_SelectWordAroundCaret_Name:
        if (message.isResponse())
          paramsClass = FrameWidgetInputHandler_SelectWordAroundCaret_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
