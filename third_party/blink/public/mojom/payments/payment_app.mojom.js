...
(function() {
  ...
  PaymentEventResponseType.PAYMENT_EVENT_REJECT = 1;
  PaymentEventResponseType.PAYMENT_EVENT_SERVICE_WORKER_ERROR = 2;
  PaymentEventResponseType.PAYMENT_HANDLER_WINDOW_CLOSING = 3;
  PaymentEventResponseType.PAYMENT_EVENT_INTERNAL_ERROR = 4;
  PaymentEventResponseType.PAYMENT_EVENT_NO_RESPONSE = 5;
  PaymentEventResponseType.PAYMENT_DETAILS_STRINGIFY_ERROR = 6;
  PaymentEventResponseType.PAYMENT_METHOD_NAME_EMPTY = 7;
  PaymentEventResponseType.PAYMENT_DETAILS_ABSENT = 8;
  PaymentEventResponseType.PAYMENT_DETAILS_NOT_OBJECT = 9;
  PaymentEventResponseType.PAYMENT_EVENT_BROWSER_ERROR = 10;
  PaymentEventResponseType.PAYMENT_EVENT_TIMEOUT = 11;
  PaymentEventResponseType.PAYMENT_HANDLER_INSECURE_NAVIGATION = 12;
  PaymentEventResponseType.PAYER_NAME_EMPTY = 13;
  PaymentEventResponseType.PAYER_EMAIL_EMPTY = 14;
  PaymentEventResponseType.PAYER_PHONE_EMPTY = 15;
  PaymentEventResponseType.SHIPPING_ADDRESS_INVALID = 16;
  PaymentEventResponseType.SHIPPING_OPTION_EMPTY = 17;
