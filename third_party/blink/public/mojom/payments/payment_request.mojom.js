...
(function() {
  ...
  PaymentErrorReason.ALREADY_SHOWING = 3;
  ...
  PaymentMethodData.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, SecurePaymentConfirmationRequest, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PaymentMethodData.decode = function(decoder) {
    ...
    val.stringifiedData =
        decoder.decodeStruct(codec.String);
    val.gpayBridgeData =
        decoder.decodeStructPointer(GooglePaymentMethodData);
    val.environment =
