...
(function() {
  ...
  VideoCaptureError.MAX_VALUE = 121,
  ...
  VideoCaptureDeviceDescriptor.prototype.initDefaults_ = function() {
    ...
    this.facingMode = 0;
    this.captureApi = 0;
    this.panTiltZoomSupported = false;
  ...
  VideoCaptureDeviceDescriptor.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 36, VideoCaptureTransportType);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoCaptureDeviceDescriptor.decode = function(decoder) {
    ...
    val.captureApi =
        decoder.decodeStruct(codec.Int32);
    packed = decoder.readUint8();
    val.panTiltZoomSupported = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.transportType =
  ...
  VideoCaptureDeviceDescriptor.encode = function(encoder, val) {
    ...
    packed = 0;
    packed |= (val.panTiltZoomSupported & 1) << 0
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
