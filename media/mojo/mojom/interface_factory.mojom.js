...
(function() {
  ...
  InterfaceFactory_CreateMediaPlayerRenderer_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.clientExtension =
        decoder.decodeStruct(new codec.Interface(renderer_extensions$.MediaPlayerRendererClientExtensionPtr));
    val.renderer =
        decoder.decodeStruct(codec.InterfaceRequest);
  ...
  InterfaceFactory_CreateFlingingRenderer_Params.decode = function(decoder) {
    ...
    val.presentationId =
        decoder.decodeStruct(codec.String);
    val.clientExtension =
        decoder.decodeStruct(new codec.Interface(renderer_extensions$.FlingingRendererClientExtensionPtr));
    val.renderer =
        decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
