...
(function() {
  ...
  VideoFrameMetadata.prototype.initDefaults_ = function() {
    ...
    this.hasResourceUtilization = false;
  ...
  VideoFrameMetadata.decode = function(decoder) {
    ...
    val.hasResourceUtilization = (packed >> 6) & 1 ? true : false;
    val.readLockFencesEnabled = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.hasRotation = (packed >> 0) & 1 ? true : false;
    val.textureOwner = (packed >> 1) & 1 ? true : false;
    val.wantsPromotionHint = (packed >> 2) & 1 ? true : false;
  ...
  VideoFrameMetadata.encode = function(encoder, val) {
    ...
    packed |= (val.hasResourceUtilization & 1) << 6
    packed |= (val.readLockFencesEnabled & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.hasRotation & 1) << 0
    packed |= (val.textureOwner & 1) << 1
    packed |= (val.wantsPromotionHint & 1) << 2
