...
(function() {
  ...
  GpuPreferences.encodedSize = codec.kStructHeaderSize + 40;
  ...
  GpuPreferences.decode = function(decoder) {
    ...
    val.enforceVulkanProtectedMemory = (packed >> 3) & 1 ? true : false;
    ...
    val.enableDawnBackendValidation = (packed >> 1) & 1 ? true : false;
  ...
  GpuPreferences.encode = function(encoder, val) {
    ...
    packed |= (val.enforceVulkanProtectedMemory & 1) << 3
    ...
    packed |= (val.enableDawnBackendValidation & 1) << 1
