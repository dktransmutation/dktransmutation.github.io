...
(function() {
  ...
  function Adapter_SetClient_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  Adapter_SetClient_ResponseParams.prototype.initDefaults_ = function() {
  };
  Adapter_SetClient_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Adapter_SetClient_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Adapter_SetClient_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  Adapter_SetClient_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new Adapter_SetClient_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  Adapter_SetClient_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Adapter_SetClient_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  function Adapter_CreateRfcommService_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  Adapter_CreateRfcommService_Params.prototype.initDefaults_ = function() {
    this.serviceName = null;
    this.serviceUuid = null;
  };
  Adapter_CreateRfcommService_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Adapter_CreateRfcommService_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate Adapter_CreateRfcommService_Params.serviceName
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate Adapter_CreateRfcommService_Params.serviceUuid
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, uuid$.UUID, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Adapter_CreateRfcommService_Params.encodedSize = codec.kStructHeaderSize + 16;

  Adapter_CreateRfcommService_Params.decode = function(decoder) {
    var packed;
    var val = new Adapter_CreateRfcommService_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.serviceName =
        decoder.decodeStruct(codec.String);
  ...
  Adapter_CreateRfcommService_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Adapter_CreateRfcommService_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.serviceName);
    encoder.encodeStructPointer(uuid$.UUID, val.serviceUuid);
  };
  function Adapter_CreateRfcommService_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  Adapter_CreateRfcommService_ResponseParams.prototype.initDefaults_ = function() {
    this.serverSocket = new ServerSocketPtr();
  };
  Adapter_CreateRfcommService_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Adapter_CreateRfcommService_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate Adapter_CreateRfcommService_ResponseParams.serverSocket
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 0, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Adapter_CreateRfcommService_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  Adapter_CreateRfcommService_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new Adapter_CreateRfcommService_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.serverSocket =
  ...
  Adapter_CreateRfcommService_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Adapter_CreateRfcommService_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  ...
  var kServerSocket_Accept_Name = 0;
  ...
  var kAdapter_SetDiscoverable_Name = 4;
  var kAdapter_SetName_Name = 5;
  var kAdapter_StartDiscoverySession_Name = 6;
  var kAdapter_ConnectToServiceInsecurely_Name = 7;
  var kAdapter_CreateRfcommService_Name = 8;
  ...
  AdapterProxy.prototype.setClient = function(client) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(Adapter_SetClient_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  AdapterPtr.prototype.createRfcommService = function() {
    return AdapterProxy.prototype.createRfcommService
        .apply(this.ptr.getProxy(), arguments);
  };

  AdapterProxy.prototype.createRfcommService = function(serviceName, serviceUuid) {
    var params_ = new Adapter_CreateRfcommService_Params();
    params_.serviceName = serviceName;
    params_.serviceUuid = serviceUuid;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kAdapter_CreateRfcommService_Name,
          codec.align(Adapter_CreateRfcommService_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(Adapter_CreateRfcommService_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(Adapter_CreateRfcommService_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  AdapterStub.prototype.createRfcommService = function(serviceName, serviceUuid) {
    return this.delegate_ && this.delegate_.createRfcommService && this.delegate_.createRfcommService(serviceName, serviceUuid);
  }
  ...
  AdapterStub.prototype.acceptWithResponder =
    ...
    case kAdapter_SetClient_Name:
      ...
      this.setClient(params.client).then(function(response) {
        var responseParams =
            new Adapter_SetClient_ResponseParams();
        var builder = new codec.MessageV1Builder(
            kAdapter_SetClient_Name,
            codec.align(Adapter_SetClient_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(Adapter_SetClient_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
    ...
    case kAdapter_ConnectToServiceInsecurely_Name:
      ...
      return true;
    case kAdapter_CreateRfcommService_Name:
      var params = reader.decodeStruct(Adapter_CreateRfcommService_Params);
      this.createRfcommService(params.serviceName, params.serviceUuid).then(function(response) {
        var responseParams =
            new Adapter_CreateRfcommService_ResponseParams();
        responseParams.serverSocket = response.serverSocket;
        var builder = new codec.MessageV1Builder(
            kAdapter_CreateRfcommService_Name,
            codec.align(Adapter_CreateRfcommService_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(Adapter_CreateRfcommService_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateAdapterRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kAdapter_CreateRfcommService_Name:
        if (message.expectsResponse())
          paramsClass = Adapter_CreateRfcommService_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateAdapterResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kAdapter_SetClient_Name:
        if (message.isResponse())
          paramsClass = Adapter_SetClient_ResponseParams;
        break;
      case kAdapter_SetDiscoverable_Name:
        if (message.isResponse())
      ...
      case kAdapter_CreateRfcommService_Name:
        if (message.isResponse())
          paramsClass = Adapter_CreateRfcommService_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
