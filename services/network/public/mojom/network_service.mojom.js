...
(function() {
  ...
  NetworkServiceClient_OnCorsPreflightRequest_Params.encodedSize = codec.kStructHeaderSize + 32;
  ...
  function NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.prototype.initDefaults_ = function() {
    this.isolatedWorldHostname = null;
  };
  NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.isolatedWorldHostname
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.encodedSize = codec.kStructHeaderSize + 8;

  NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.isolatedWorldHostname =
        decoder.decodeStruct(codec.String);
    return val;
  };

  NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.isolatedWorldHostname);
  };
  ...
  var kNetworkServiceClient_OnCorsPreflightRequest_Name = 4;
  var kNetworkServiceClient_OnCorsPreflightResponse_Name = 5;
  var kNetworkServiceClient_OnCorsPreflightRequestCompleted_Name = 6;
  var kNetworkServiceClient_LogCrossOriginFetchFromContentScript3_Name = 7;
  ...
  NetworkServiceClientProxy.prototype.onRawRequest = function(processId, routingId, devtoolRequestId, cookiesWithAccessResult, headers) {
  ...
  NetworkServiceClientProxy.prototype.onRawResponse = function(processId, routingId, devtoolRequestId, cookiesWithAccessResult, headers, rawResponseHeaders) {
  ...
  NetworkServiceClientProxy.prototype.onCorsPreflightRequest = function(processId, renderFrameId, devtoolRequestId, request, initiatorUrl) {
  ...
  NetworkServiceClientPtr.prototype.logCrossOriginFetchFromContentScript3 = function() {
    return NetworkServiceClientProxy.prototype.logCrossOriginFetchFromContentScript3
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkServiceClientProxy.prototype.logCrossOriginFetchFromContentScript3 = function(isolatedWorldHostname) {
    var params_ = new NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params();
    params_.isolatedWorldHostname = isolatedWorldHostname;
    var builder = new codec.MessageV0Builder(
        kNetworkServiceClient_LogCrossOriginFetchFromContentScript3_Name,
        codec.align(NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params.encodedSize));
    builder.encodeStruct(NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  NetworkServiceClientStub.prototype.onRawRequest = function(processId, routingId, devtoolRequestId, cookiesWithAccessResult, headers) {
    return this.delegate_ && this.delegate_.onRawRequest && this.delegate_.onRawRequest(processId, routingId, devtoolRequestId, cookiesWithAccessResult, headers);
  }
  NetworkServiceClientStub.prototype.onRawResponse = function(processId, routingId, devtoolRequestId, cookiesWithAccessResult, headers, rawResponseHeaders) {
    return this.delegate_ && this.delegate_.onRawResponse && this.delegate_.onRawResponse(processId, routingId, devtoolRequestId, cookiesWithAccessResult, headers, rawResponseHeaders);
  }
  NetworkServiceClientStub.prototype.onCorsPreflightRequest = function(processId, renderFrameId, devtoolRequestId, request, initiatorUrl) {
    return this.delegate_ && this.delegate_.onCorsPreflightRequest && this.delegate_.onCorsPreflightRequest(processId, renderFrameId, devtoolRequestId, request, initiatorUrl);
  }
  ...
  NetworkServiceClientStub.prototype.logCrossOriginFetchFromContentScript3 = function(isolatedWorldHostname) {
    return this.delegate_ && this.delegate_.logCrossOriginFetchFromContentScript3 && this.delegate_.logCrossOriginFetchFromContentScript3(isolatedWorldHostname);
  }
  ...
  NetworkServiceClientStub.prototype.accept = function(message) {
    ...
    case kNetworkServiceClient_OnRawRequest_Name:
      ...
      this.onRawRequest(params.processId, params.routingId, params.devtoolRequestId, params.cookiesWithAccessResult, params.headers);
      return true;
    case kNetworkServiceClient_OnRawResponse_Name:
      var params = reader.decodeStruct(NetworkServiceClient_OnRawResponse_Params);
      this.onRawResponse(params.processId, params.routingId, params.devtoolRequestId, params.cookiesWithAccessResult, params.headers, params.rawResponseHeaders);
      return true;
    case kNetworkServiceClient_OnCorsPreflightRequest_Name:
      ...
      this.onCorsPreflightRequest(params.processId, params.renderFrameId, params.devtoolRequestId, params.request, params.initiatorUrl);
      return true;
    ...
    case kNetworkServiceClient_OnCorsPreflightRequestCompleted_Name:
      ...
      return true;
    case kNetworkServiceClient_LogCrossOriginFetchFromContentScript3_Name:
      var params = reader.decodeStruct(NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params);
      this.logCrossOriginFetchFromContentScript3(params.isolatedWorldHostname);
      return true;
    default:
      return false;
    }
  ...
  function validateNetworkServiceClientRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkServiceClient_LogCrossOriginFetchFromContentScript3_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = NetworkServiceClient_LogCrossOriginFetchFromContentScript3_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var kNetworkService_GetTotalNetworkUsages_Name = 14;
  var kNetworkService_GetNetworkList_Name = 15;
  var kNetworkService_UpdateCRLSet_Name = 16;
  var kNetworkService_UpdateLegacyTLSConfig_Name = 17;
  var kNetworkService_OnCertDBChanged_Name = 18;
  var kNetworkService_AddCorbExceptionForPlugin_Name = 19;
  var kNetworkService_AddAllowedRequestInitiatorForPlugin_Name = 20;
  var kNetworkService_RemoveSecurityExceptionsForPlugin_Name = 21;
  var kNetworkService_OnMemoryPressure_Name = 22;
  var kNetworkService_OnPeerToPeerConnectionsCountChange_Name = 23;
  var kNetworkService_OnApplicationStateChange_Name = 24;
  var kNetworkService_SetEnvironment_Name = 25;
  var kNetworkService_SetTrustTokenKeyCommitments_Name = 26;
  var kNetworkService_ClearSCTAuditingCache_Name = 27;
  var kNetworkService_DumpWithoutCrashing_Name = 28;
  var kNetworkService_BindTestInterface_Name = 29;
