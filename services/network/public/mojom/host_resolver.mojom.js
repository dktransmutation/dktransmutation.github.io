...
(function() {
  ...
  DnsConfigOverrides.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 44, DnsConfigOverrides.Tristate);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 52, OptionalSecureDnsMode);
    if (err !== validator.validationError.NONE)
        return err;


    // validate DnsConfigOverrides.allowDnsOverHttpsUpgrade
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 64, DnsConfigOverrides.Tristate);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DnsConfigOverrides.decode = function(decoder) {
    ...
    val.hosts =
        decoder.decodeArrayPointer(new codec.PointerTo(DnsHost));
