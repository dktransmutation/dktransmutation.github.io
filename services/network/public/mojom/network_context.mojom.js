...
(function() {
  ...
  NetworkContextParams.CorsMode = {};
  NetworkContextParams.CorsMode.kDefault = 0;
  NetworkContextParams.CorsMode.kDisable = 1;
  NetworkContextParams.CorsMode.kEnable = 2;
  NetworkContextParams.CorsMode.MIN_VALUE = 0,
  NetworkContextParams.CorsMode.MAX_VALUE = 2,

  NetworkContextParams.CorsMode.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  NetworkContextParams.CorsMode.validate = function(enumValue) {
    var isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  NetworkContextParams.prototype.initDefaults_ = function() {
    ...
    this.corsMode = NetworkContextParams.CorsMode.kDefault;
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 144, 8, new codec.PointerTo(ct_log_info$.CTLogInfo), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateUnion(offset + codec.kStructHeaderSize + 168, CertVerifierParams, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextParams.cookieManager
    ...
    // validate NetworkContextParams.corsMode
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 232, NetworkContextParams.CorsMode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextParams.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.NullableInterfaceRequest, val.cookieManager);
    ...
    encoder.encodeStruct(codec.Int32, val.corsMode);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  URLLoaderFactoryParams.prototype.initDefaults_ = function() {
    ...
    this.factoryBoundAccessPatterns = null;
  ...
  URLLoaderFactoryParams.validate = function(messageValidator, offset) {
    ...
    // validate URLLoaderFactoryParams.factoryBoundAccessPatterns
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, cors_origin_pattern$.CorsOriginAccessPatterns, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, URLLoaderFactoryOverride, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLLoaderFactoryParams.clientSecurityState
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 56, ClientSecurityState, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoaderFactoryParams.decode = function(decoder) {
    ...
    val.factoryBoundAccessPatterns =
        decoder.decodeStructPointer(cors_origin_pattern$.CorsOriginAccessPatterns);
    val.isolationInfo =
    ...
    val.clientSecurityState =
        decoder.decodeStructPointer(ClientSecurityState);
    val.coepReporter =
  ...
  URLLoaderFactoryParams.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(cors_origin_pattern$.CorsOriginAccessPatterns, val.factoryBoundAccessPatterns);
    ...
    encoder.encodeStructPointer(ClientSecurityState, val.clientSecurityState);
  ...
  NetworkContextClient_OnFileUploadRequested_ResponseParams.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.files =
        decoder.decodeArrayPointer(new codec.PointerTo(file$.File));
    return val;
  };
  ...
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.authNegotiateAndroidAccountType =
        decoder.decodeStruct(codec.String);
    val.spn =
        decoder.decodeStruct(codec.String);
    return val;
  ...
  function NetworkContextClient_OnSCTReportReady_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkContextClient_OnSCTReportReady_Params.prototype.initDefaults_ = function() {
    this.cacheKey = null;
  };
  NetworkContextClient_OnSCTReportReady_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContextClient_OnSCTReportReady_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextClient_OnSCTReportReady_Params.cacheKey
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextClient_OnSCTReportReady_Params.encodedSize = codec.kStructHeaderSize + 8;

  NetworkContextClient_OnSCTReportReady_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkContextClient_OnSCTReportReady_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.cacheKey =
        decoder.decodeStruct(codec.String);
  ...
  NetworkContextClient_OnSCTReportReady_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContextClient_OnSCTReportReady_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.cacheKey);
  };
  ...
  NetworkContext_VerifyCertForSignedExchange_ResponseParams.decode = function(decoder) {
    ...
    val.ctResult =
        decoder.decodeStructPointer(network_param$.CTVerifyResult);
    return val;
  };
  ...
  var kNetworkContextClient_OnGenerateHttpNegotiateAuthToken_Name = 7;
  var kNetworkContextClient_OnSCTReportReady_Name = 8;
  ...
  NetworkContextClientPtr.prototype.onSCTReportReady = function() {
    return NetworkContextClientProxy.prototype.onSCTReportReady
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkContextClientProxy.prototype.onSCTReportReady = function(cacheKey) {
    var params_ = new NetworkContextClient_OnSCTReportReady_Params();
    params_.cacheKey = cacheKey;
    var builder = new codec.MessageV0Builder(
        kNetworkContextClient_OnSCTReportReady_Name,
        codec.align(NetworkContextClient_OnSCTReportReady_Params.encodedSize));
    builder.encodeStruct(NetworkContextClient_OnSCTReportReady_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  NetworkContextClientStub.prototype.onSCTReportReady = function(cacheKey) {
    return this.delegate_ && this.delegate_.onSCTReportReady && this.delegate_.onSCTReportReady(cacheKey);
  }
  ...
  NetworkContextClientStub.prototype.accept = function(message) {
    ...
    case kNetworkContextClient_OnCertificateRequested_Name:
      ...
      return true;
    case kNetworkContextClient_OnSCTReportReady_Name:
      var params = reader.decodeStruct(NetworkContextClient_OnSCTReportReady_Params);
      this.onSCTReportReady(params.cacheKey);
      return true;
    default:
      return false;
    }
  ...
  function validateNetworkContextClientRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkContextClient_OnSCTReportReady_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = NetworkContextClient_OnSCTReportReady_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var kNetworkContext_GetHasTrustTokensAnswerer_Name = 5;
  var kNetworkContext_ClearTrustTokenData_Name = 6;
  var kNetworkContext_ClearNetworkingHistorySince_Name = 7;
  var kNetworkContext_ClearHttpCache_Name = 8;
  var kNetworkContext_ComputeHttpCacheSize_Name = 9;
  var kNetworkContext_NotifyExternalCacheHit_Name = 10;
  var kNetworkContext_ClearHostCache_Name = 11;
  var kNetworkContext_ClearHttpAuthCache_Name = 12;
  var kNetworkContext_ClearReportingCacheReports_Name = 13;
  var kNetworkContext_ClearReportingCacheClients_Name = 14;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 15;
  var kNetworkContext_ClearDomainReliability_Name = 16;
  var kNetworkContext_GetDomainReliabilityJSON_Name = 17;
  var kNetworkContext_QueueReport_Name = 18;
  var kNetworkContext_QueueSignedExchangeReport_Name = 19;
  var kNetworkContext_CloseAllConnections_Name = 20;
  var kNetworkContext_CloseIdleConnections_Name = 21;
  var kNetworkContext_SetNetworkConditions_Name = 22;
  var kNetworkContext_SetAcceptLanguage_Name = 23;
  var kNetworkContext_SetEnableReferrers_Name = 24;
  var kNetworkContext_SetCTPolicy_Name = 25;
  var kNetworkContext_AddExpectCT_Name = 26;
  var kNetworkContext_SetExpectCTTestReport_Name = 27;
  var kNetworkContext_GetExpectCTState_Name = 28;
  var kNetworkContext_CreateUDPSocket_Name = 29;
  var kNetworkContext_CreateTCPServerSocket_Name = 30;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 31;
  var kNetworkContext_CreateTCPBoundSocket_Name = 32;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 33;
  var kNetworkContext_LookUpProxyForURL_Name = 34;
  var kNetworkContext_ForceReloadProxyConfig_Name = 35;
  var kNetworkContext_ClearBadProxiesCache_Name = 36;
  var kNetworkContext_CreateWebSocket_Name = 37;
  var kNetworkContext_CreateQuicTransport_Name = 38;
  var kNetworkContext_CreateNetLogExporter_Name = 39;
  var kNetworkContext_PreconnectSockets_Name = 40;
  var kNetworkContext_CreateP2PSocketManager_Name = 41;
  var kNetworkContext_CreateMdnsResponder_Name = 42;
  var kNetworkContext_ResolveHost_Name = 43;
  var kNetworkContext_CreateHostResolver_Name = 44;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 45;
  var kNetworkContext_ParseHeaders_Name = 46;
  var kNetworkContext_AddHSTS_Name = 47;
  var kNetworkContext_IsHSTSActiveForHost_Name = 48;
  var kNetworkContext_GetHSTSState_Name = 49;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 50;
  var kNetworkContext_DeleteDynamicDataForHost_Name = 51;
  var kNetworkContext_SetSplitAuthCacheByNetworkIsolationKey_Name = 52;
  var kNetworkContext_SaveHttpAuthCacheProxyEntries_Name = 53;
  var kNetworkContext_LoadHttpAuthCacheProxyEntries_Name = 54;
  var kNetworkContext_AddAuthCacheEntry_Name = 55;
  var kNetworkContext_LookupServerBasicAuthCredentials_Name = 56;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 57;
  var kNetworkContext_VerifyCertificateForTesting_Name = 58;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 59;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 60;
  var kNetworkContext_GetOriginPolicyManager_Name = 61;
  var kNetworkContext_SetSCTAuditingEnabled_Name = 62;
  ...
  NetworkContextProxy.prototype.getRestrictedCookieManager = function(restrictedCookieManager, role, origin, siteForCookies, topFrameOrigin, cookieObserver) {
  ...
  NetworkContextStub.prototype.getRestrictedCookieManager = function(restrictedCookieManager, role, origin, siteForCookies, topFrameOrigin, cookieObserver) {
    return this.delegate_ && this.delegate_.getRestrictedCookieManager && this.delegate_.getRestrictedCookieManager(restrictedCookieManager, role, origin, siteForCookies, topFrameOrigin, cookieObserver);
  }
  ...
  NetworkContextStub.prototype.accept = function(message) {
    ...
    case kNetworkContext_GetRestrictedCookieManager_Name:
      ...
      this.getRestrictedCookieManager(params.restrictedCookieManager, params.role, params.origin, params.siteForCookies, params.topFrameOrigin, params.cookieObserver);
      return true;
