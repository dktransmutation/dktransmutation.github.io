...
(function() {
  ...
  CrossOriginOpenerPolicyReporter_QueueAccessReport_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  var kCrossOriginOpenerPolicyReporter_Clone_Name = 1;
  ...
  CrossOriginOpenerPolicyReporterProxy.prototype.queueAccessReport = function(reportType, property, sourceLocation) {
  ...
  CrossOriginOpenerPolicyReporterStub.prototype.queueAccessReport = function(reportType, property, sourceLocation) {
    return this.delegate_ && this.delegate_.queueAccessReport && this.delegate_.queueAccessReport(reportType, property, sourceLocation);
  }
  ...
  CrossOriginOpenerPolicyReporterStub.prototype.accept = function(message) {
    ...
    case kCrossOriginOpenerPolicyReporter_QueueAccessReport_Name:
      ...
      this.queueAccessReport(params.reportType, params.property, params.sourceLocation);
      return true;
