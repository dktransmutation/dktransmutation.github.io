...
(function() {
  ...
  URLResponseHead.prototype.initDefaults_ = function() {
    ...
    this.responseType = fetch_api$.FetchResponseType.kBasic;
    this.certStatus = 0;
  ...
  URLResponseHead.encodedSize = codec.kStructHeaderSize + 224;
  ...
  URLResponseHead.decode = function(decoder) {
    ...
    val.interceptedByPlugin = (packed >> 5) & 1 ? true : false;
    val.isLegacyTlsVersion = (packed >> 6) & 1 ? true : false;
    val.timingAllowPassed = (packed >> 7) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    val.contentLength =
  ...
  URLResponseHead.encode = function(encoder, val) {
    ...
    packed |= (val.interceptedByPlugin & 1) << 5
    packed |= (val.isLegacyTlsVersion & 1) << 6
    packed |= (val.timingAllowPassed & 1) << 7
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
