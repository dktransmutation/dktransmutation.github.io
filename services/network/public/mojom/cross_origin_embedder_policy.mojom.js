...
(function() {
  ...
  CrossOriginEmbedderPolicyReporterProxy.prototype.queueCorpViolationReport = function(blockedUrl, reportOnly) {
  ...
  CrossOriginEmbedderPolicyReporterStub.prototype.queueCorpViolationReport = function(blockedUrl, reportOnly) {
    return this.delegate_ && this.delegate_.queueCorpViolationReport && this.delegate_.queueCorpViolationReport(blockedUrl, reportOnly);
  }
  ...
  CrossOriginEmbedderPolicyReporterStub.prototype.accept = function(message) {
    ...
    case kCrossOriginEmbedderPolicyReporter_QueueCorpViolationReport_Name:
      ...
      this.queueCorpViolationReport(params.blockedUrl, params.reportOnly);
      return true;
