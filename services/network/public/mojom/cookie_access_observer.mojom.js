...
(function() {
  ...
  CookieAccessDetails.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 24, 8, new codec.PointerTo(cookie_manager$.CookieWithAccessResult), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieAccessDetails.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(cookie_manager$.CookieWithAccessResult), val.cookieList);
  ...
  var kCookieAccessObserver_OnCookiesAccessed_Name = 0;
  var kCookieAccessObserver_Clone_Name = 1;
