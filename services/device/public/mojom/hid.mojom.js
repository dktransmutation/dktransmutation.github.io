...
(function() {
  ...
  HidDeviceInfo.encodedSize = codec.kStructHeaderSize + 96;
  ...
  HidManager_Connect_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  HidManagerProxy.prototype.connect = function(deviceGuid, connectionClient, watcher) {
  ...
  HidManagerStub.prototype.connect = function(deviceGuid, connectionClient, watcher) {
    return this.delegate_ && this.delegate_.connect && this.delegate_.connect(deviceGuid, connectionClient, watcher);
  }
  ...
  HidManagerStub.prototype.acceptWithResponder =
    ...
    case kHidManager_Connect_Name:
      ...
      this.connect(params.deviceGuid, params.connectionClient, params.watcher).then(function(response) {
        var responseParams =
