...
(function() {
  ...
  SerialPortInfo.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 24, DeviceType);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SerialPort_Open_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kSerialPortManager_GetPort_Name = 2;
  ...
  var kSerialPort_StartWriting_Name = 1;
  var kSerialPort_StartReading_Name = 2;
  var kSerialPort_Flush_Name = 3;
  var kSerialPort_Drain_Name = 4;
  var kSerialPort_GetControlSignals_Name = 5;
  var kSerialPort_SetControlSignals_Name = 6;
  var kSerialPort_ConfigurePort_Name = 7;
  var kSerialPort_GetPortInfo_Name = 8;
  var kSerialPort_Close_Name = 9;
  ...
  SerialPortProxy.prototype.open = function(options, client) {
  ...
  SerialPortStub.prototype.open = function(options, client) {
    return this.delegate_ && this.delegate_.open && this.delegate_.open(options, client);
  }
  ...
  SerialPortStub.prototype.acceptWithResponder =
    ...
    case kSerialPort_Open_Name:
      ...
      this.open(params.options, params.client).then(function(response) {
        var responseParams =
