...
(function() {
  ...
  NDEFErrorType.NOT_FOUND = 3;
  NDEFErrorType.INVALID_MESSAGE = 4;
  NDEFErrorType.OPERATION_CANCELLED = 5;
  NDEFErrorType.CANNOT_CANCEL = 6;
  NDEFErrorType.IO_ERROR = 7;
  NDEFErrorType.MIN_VALUE = 0,
  NDEFErrorType.MAX_VALUE = 7,
  ...
  NDEFWriteOptions.decode = function(decoder) {
    ...
    val.overwrite = (packed >> 1) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  function NDEFScanOptions(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NDEFScanOptions.prototype.initDefaults_ = function() {
    this.id = null;
    this.recordType = null;
    this.mediaType = null;
  };
  NDEFScanOptions.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NDEFScanOptions.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NDEFScanOptions.id
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, true)
    if (err !== validator.validationError.NONE)
        return err;


    // validate NDEFScanOptions.recordType
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 8, true)
    if (err !== validator.validationError.NONE)
        return err;


    // validate NDEFScanOptions.mediaType
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 16, true)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NDEFScanOptions.encodedSize = codec.kStructHeaderSize + 24;

  NDEFScanOptions.decode = function(decoder) {
    var packed;
    var val = new NDEFScanOptions();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.id =
        decoder.decodeStruct(codec.NullableString);
  ...
  NDEFScanOptions.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NDEFScanOptions.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.NullableString, val.id);
  ...
  NFC_Watch_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, NDEFScanOptions, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NFC_Watch_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.options =
        decoder.decodeStructPointer(NDEFScanOptions);
    val.id =
  ...
  NFC_Watch_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(NDEFScanOptions, val.options);
  ...
  NFCStub.prototype.acceptWithResponder =
    ...
    case kNFC_CancelPush_Name:
      ...
      this.cancelPush().then(function(response) {
        var responseParams =
  ...
  exports.NDEFScanOptions = NDEFScanOptions;
  exports.NFC = NFC;
