...
(function() {
  ...
  MediaSessionAction.MAX_VALUE = 11,
  ...
  MediaSessionInfo.validate = function(messageValidator, offset) {
    ...
    // version check MediaSessionInfo.audioVideoState
    if (!messageValidator.isFieldInStructVersion(offset, 8))
      return validator.validationError.NONE;
    // validate MediaSessionInfo.audioVideoState
  ...
  MediaSessionInfo.encodedSize = codec.kStructHeaderSize + 32;
  ...
  MediaSessionInfo.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.audioVideoState);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
